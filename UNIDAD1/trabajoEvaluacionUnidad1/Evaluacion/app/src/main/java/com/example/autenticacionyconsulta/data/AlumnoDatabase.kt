...
@Database(entities = [CredencialesAlumno::class,
    FinalesAlumno::class,
    HorarioAlumno::class,
    InformacionAlumno::class,
    KardexMateria::class,
    ParcialesAlumno::class,
    ResumenKardex::class],
    ...
    companion object {
        ...
        fun getDatabase(context: Context): AlumnoDatabase {
            return Instance ?: synchronized(this) {
                Room.databaseBuilder(context, AlumnoDatabase::class.java, "alumno_database").build().also { Instance = it }
            }
        }
    }
}
